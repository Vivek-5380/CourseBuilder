    ...
    <>
      <div className="wrapper flex justify-center w-full p-10 min-h-[92vh]">
        <div className="screen w-full lg:w-[65%] md:w-[80%] space-y-8">
          ...
          <Header dropdownMenu = {dropdownMenu} setCreateModuleOverlay = {setCreateModuleOverlay} setDropdownMenu = {setDropdownMenu} setActiveResourceId = {setActiveResourceId} setEditDropdownMenu = {setEditDropdownMenu} setActiveResourceType = {setActiveResourceType} setAddLinkOverlay = {setAddLinkOverlay} handleUploadFile = {handleUploadFile} />
